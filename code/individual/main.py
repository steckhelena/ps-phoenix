...
def max_blob(matriz):
    ...
    # dimensões, checando por exemplo se a largura é maior que a altura para a identificação do céu. Outro metodo seria
    # ler a imagem ao contrario procurando o primeiro ponto branco da parte de baixo da imagem, isto assumindo que a
    # função gaussian_blur tenha eliminado todas as impurezas.
...
def main():
    ...
    # Agora decidimos os valores para se utilizar na função threshold, com essa função não precisamos melhorar o
    # contraste da imagem, pois ele calcula um histograma das cores para achar o melhor valor no qual dividir o
    # branco do preto na matriz binária.
